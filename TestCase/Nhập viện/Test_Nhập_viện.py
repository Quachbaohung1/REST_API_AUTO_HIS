...
from Khám_bệnh_Nhập_viện.PUT import (
    update_hospitalize_patient_from_excel,
)
...
class TestProcessHospitalize(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.file_path = "D://HIS api automation/DataTest/Nhập viện/TC_01.xlsx"
    ...
    def test_case_01(self):
        # Cho bệnh nhân BHYT
        testcase_id = "NV_01"
        entry_ids = [49861, 49864]
        # Chạy hàm process_examination_services một lần và lưu kết quả vào biến tạm
        expected_result_temp = update_hospitalize_patient_from_excel(self.test_data, testcase_id, entry_ids)
